        ...
        >
            ...
            >
                ...
                <div style={{ maxWidth: '600px' }}>
                    <h1 style={{ fontSize: isMobile ? '20px' : '24px', marginBottom: '0.5em' }}>
                        Isabelle Strobel
                    </h1>

                    <p style={{ fontSize: isMobile ? '14px' : '16px', lineHeight: '1.6' }}>
                    ...
                    <p style={{ fontSize: isMobile ? '14px' : '16px', lineHeight: '1.6' }}>
                        ...
                        número <b>352.465</b>, podendo ser verificada a regularidade de sua inscrição no Cadastro Nacional da Advocacia:{" "}
                        <a href="https://cna.oab.org.br/" target="_blank" rel="noreferrer" style={{ color: 'white' }}>
